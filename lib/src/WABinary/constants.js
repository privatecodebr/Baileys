...
exports.TOKEN_MAP = {};
for (var _i = 0, _a = exports.SINGLE_BYTE_TOKENS.entries(); _i < _a.length; _i++) {
    var _b = _a[_i], i = _b[0], SINGLE_BYTE_TOKEN = _b[1];
    exports.TOKEN_MAP[SINGLE_BYTE_TOKEN] = { index: i };
}
for (var _c = 0, _d = exports.DOUBLE_BYTE_TOKENS.entries(); _c < _d.length; _c++) {
    var _e = _d[_c], i = _e[0], DOUBLE_BYTE_TOKEN = _e[1];
    for (var _f = 0, _g = DOUBLE_BYTE_TOKEN.entries(); _f < _g.length; _f++) {
        var _h = _g[_f], j = _h[0], element = _h[1];
