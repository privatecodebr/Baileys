...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    productCreate: (create: ProductCreate) => Promise<import("../Types/index.js").Product>;
    productDelete: (productIds: string[]) => Promise<{
        deleted: number;
    }>;
    productUpdate: (productId: string, update: ProductUpdate) => Promise<import("../Types/index.js").Product>;
    ...
    createParticipantNodes: (jids: string[], message: import("../Types/index.js").WAProto.IMessage, extraAttrs?: BinaryNode["attrs"]) => Promise<{
        nodes: BinaryNode[];
