...
var _gcLimit = 10000;
function _asyncQueueExecutor(queue, cleanup) {
    return __awaiter(this, void 0, void 0, function () {
        var offt, limit, i, job, _a, _b, e_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    limit = Math.min(queue.length, _gcLimit);
                    i = offt;
                    _c.label = 2;
                case 2:
                    if (!(i < limit)) return [3 /*break*/, 7];
                    job = queue[i];
                    _c.label = 3;
                case 3:
                    _c.trys.push([3, 5, , 6]);
                    _b = (_a = job).resolve;
                    return [4 /*yield*/, job.awaitable()];
                case 4:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 6];
                case 5:
...
function queueJob(bucket, awaitable) {
    ...
    if (inactive) {
        _asyncQueueExecutor(queue, function () { return _queueAsyncBuckets.delete(bucket); });
    }
    return job;
}
